...
const char HTTP_ERASEBTN[] PROGMEM =
	           "<br/><form action='/erase' method='get'><button class='D'>WiFi Konfiguration löschen</button></form>";
...
const char HTTP_INFO_lastreset[] PROGMEM =
	           "<dt>Grund für die letzte Zurücksetzung</dt><dd>CPU0: {1}<br/>CPU1: {2}</dd>";
